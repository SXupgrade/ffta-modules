...
//$svgBase = $CFG->ROOT_DIR . 'Modules/Custom/ffta-modules/modules/plan-finales/legacy/svg/';
$svgBase = $CFG->ROOT_DIR . 'Common/Images/Targets/';
$pfRoot  = $CFG->ROOT_DIR . 'Modules/Custom/ffta-modules/modules/plan-finales/legacy/';

$JS_SCRIPT = [
    '<link rel="stylesheet" href="' . $CFG->ROOT_DIR . 'Modules/Custom/ffta-modules/modules/plan-finales/legacy/lib/dragula.min.css">',
    '<link rel="stylesheet" href="' . $pfRoot . 'finalesP.css">',
    '<script src="' . $CFG->ROOT_DIR . 'Modules/Custom/ffta-modules/modules/plan-finales/legacy/lib/dragula.min.js"></script>',
